...
consultation_kb = InlineKeyboardMarkup(
    inline_keyboard=[
        [InlineKeyboardButton(
            ...
            url="https://t.me/Alexey_melnik?text=Привет! Я прошёл тест на психотипы и хочу получить консультацию 🙏"
        )]
    ]
)
...
async def show_result(message, user_id):
    ...
    await message.answer(result, reply_markup=consultation_kb)
