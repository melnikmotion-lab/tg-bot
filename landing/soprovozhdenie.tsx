...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .card .spots { font-weight: 600; margin: 0 0 22px; }
  ...
  .price { display: flex; flex-wrap: wrap; align-items: baseline; gap: 6px 14px; margin: 4px 0 18px; }
  .price-sum { font: 800 clamp(2rem, 7vw, 2.6rem)/1 var(--display); letter-spacing: -0.01em; }
  ...
  <section id="offer">
    <div class="wrap">
      <article class="card">
        ...
        <p class="spots">💡 В этом месяце я возьму <b>5 человек</b> в работу, которым помогу перестать играть в угадайку с выбором своей деятельности и понять, кто вы и чем вам заниматься в жизни.</p>
