...
<meta name="description" content="Твоё призвание: дело, ради которого ты живёшь, за 60 дней.">
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .price { display: flex; flex-wrap: wrap; align-items: baseline; gap: 6px 16px; margin: 8px 0 24px; }
  .price-sum { font: 800 clamp(3.2rem, 14vw, 5rem)/1 var(--display); letter-spacing: -0.02em; }
  .price-note { font-size: 1.1rem; }
</style>
</head>
<body>
...
<header class="hero">
  <div class="wrap">
    ...
    <p class="tagline">Дело, ради которого ты живёшь, за 60 дней</p>
    <p class="lead">Для тех, кто не удовлетворён своей работой, находится в поиске новой деятельности и способа себя реализовать. <b>И особенно для тех, кому 30+, а вы так и не поняли, кем хотите стать, когда вырастете.</b></p>
...
<main>
  <section>
    <div class="wrap">
      <div class="callout"><p>💡 В этом месяце я возьму <b>5 человек</b> в работу, которым помогу перестать играть в угадайку с выбором своей деятельности и понять, кто вы и чем вам заниматься в жизни.</p></div>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      ...
      <p>Мы наведём порядок в трёх ключевых сферах вашей жизни, чтобы вы <b>поняли, кто вы</b>, <b>нашли свой способ реализации</b> и смогли <b>выстроить жизнь, о которой вы мечтаете</b>. <em>Это не очередные умные лекции, а возможность изменить вашу жизнь.</em></p>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      ...
      <p>Хотите сменить деятельность или начать что-то новое — <b>но страшно.</b> Страшно, потому что это уже не первый раз: мечтали, горели, занимались этим и снова разочаровывались, оказываясь в той же самой начальной точке, где опять приходится выбирать. <em>И с каждым разом этот страх выбора парализует всё сильнее.</em></p>
      <p>Наша цель — <b>раз и навсегда определить, что конкретно вам подходит</b>, чтобы больше не гадать и не бояться очередной ошибки. И это станет возможным, когда вы узнаете свои врождённые склонности и таланты — и это станет вашим преимуществом, которым многие не пользуются просто потому, что не понимают свою природу. <em>А когда знаешь, то каждое решение, каждый шаг становится уверенным.</em></p>
      <p>Если вы не понимаете природу своей личности и её самые сильные стороны, то даже смена работы, покупка курса «Как быстро заработать на ИИ в 2026 году без вложений» или новая мотивационная книга не принесут ничего, кроме <b>временного облегчения и нового витка поисков</b>.</p>
      <p>Поэтому в первую очередь мы проведём <b>личную диагностику 1-1</b>, на которой:</p>
      <ul>
  ...
  <section>
    <div class="wrap">
      ...
      <p>Любая реализация стоит на трёх вещах — <b>природа, деятельность и среда</b>, в которой вы действуете. Когда мы знаем вашу природу — мы соединяем её с деятельностью и находим не абстрактное «дело жизни», а то, где <b>ваши сильные стороны работают без сопротивления</b>. Мы разберём:</p>
      <ul>
      ...
      <p><em>Самое прекрасное во всём этом, что у вас уже есть опыт, качества и склонности, которые нужно просто направить в нужную сторону, а не придумывать с нуля.</em></p>
      <p>Мы не придумываем вам новое занятие. У вас уже есть врождённые качества и таланты — что-то уже раскрыто, что-то наработано опытом. Мы собираем это вместе и направляем туда, <b>где вы раскроетесь сильнее всего</b>.</p>
    </div>
  </section>
  ...
  <section>
    <div class="wrap">
      ...
      <p><b>Знать свою природу и найти дело — это половина пути.</b> Вторая половина — не растерять это при первой же трудности, не откатиться обратно в старое и привычное мышление.</p>
      <p>Именно поэтому нужно не разовое понимание себя, а фундамент — состояние, из которого вы действуете постоянно, что бы ни происходило вокруг. <b>Такое состояние — ваша опора на всю жизнь.</b> Состояние, управляемое вашим пониманием себя, а не тревогой и сомнениями. <em>Когда вы точно знаете, кто вы. А не пытаетесь в очередной раз угадать, кем стать.</em></p>
      ...
      <p>Влияя на эти элементы, мы меняем состояние, качество решений и результаты, которые вы получаете в жизни. Цель этой фазы — <b>научиться легко возвращаться в правильное состояние</b>, в котором вы не зависите от обстоятельств. Чтобы вы могли спокойно принимать решения, оставаться собой и жить в удовольствие, даже когда происходит что-то трудное.</p>
    </div>
  </section>
  ...
  <section id="offer">
    <div class="wrap">
      <article class="card">
        <h3>Стоимость</h3>
        <p>Полная стоимость работы со мной — $800. <em>Я понимаю, что платить всю сумму сразу, не понимая, как пойдёт, — так себе идея.</em> Поэтому можно неделями.</p>
        <p>Вы платите <b>$100 в неделю</b> и получаете:</p>
        <ul>
        ...
        <p>А дальше уже будете решать — подходит вам наше сотрудничество или нет. <b>Стартуем сразу после оплаты.</b></p>
        <p class="price"><span class="price-sum">$800</span><span class="price-note">или <b>$100 в неделю</b></span></p>
  ...
  <section>
    <div class="wrap">
      ...
      <p>Через <b>60 дней</b> с начала работы у вас будет:</p>
      <ul>
        <li><b>чёткое понимание</b> своей индивидуальной природы, которое уберёт страх начинать новое раз и навсегда;</li>
        <li><b>конкретная сфера</b> или формат деятельности, в которых вы раскрываетесь сильнее всего;</li>
        <li><b>рабочий способ</b> за минуты возвращаться в состояние, в котором вы способны достигать целей, а не реагировать по привычке, теряя способность трезво мыслить.</li>
      </ul>
    </div>
  </section>
